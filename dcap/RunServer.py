...
def main():
    ...
    parser.add_argument('-t','--tasks',type = str, default = './server/tasks/demoMatlabTask.txt', dest = 'pathToTasks', help='Specify where the tasks are locationed. Default is ./tasks.txt')
