...
def main():
    ...
    # parser.add_argument('-t','--tasks',type = str, default = '../tasks/testBnetTasks.txt', dest = 'pathToTasks', help='Specify where the tasks are locationed. Default is ./tasks.txt')
    parser.add_argument('-t','--tasks',type = str, default = '../tasks/combinedTasks.txt', dest = 'pathToTasks', help='Specify where the tasks are locationed. Default is ./tasks.txt')
